...
# Identify the outliers
outliers <- which(data$avg_glucose_level < lower_bound | data$avg_glucose_level > upper_bound)

# Replace outliers with the median value
median_val <- median(data$avg_glucose_level)
data$avg_glucose_level[outliers] <- median_val
